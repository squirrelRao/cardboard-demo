...
//    boolean fromNearToFar = true;
    ...
    public void onNewFrame(HeadTransform headTransform) {
        ...
        */
        ...
        //move cubue
//        float z = 0;
//        if(moveStep < farest && moveStep > nearest && fromNearToFar){
//            z = 0 - mZ;
//            moveStep++;
//        }else if(moveStep == farest){
//            moveStep = farest - 1;
//            fromNearToFar = false;
//        }else if(moveStep < farest && moveStep > nearest && !fromNearToFar){
//            z = mZ;
//            moveStep--;
//        }else if(moveStep == nearest){
//            moveStep = nearest + 1;
//            fromNearToFar = true;
//        }
//
//        Log.i("Cardboard","moveStep = "+moveStep+" , z="+z);
//        Matrix.translateM(this.mModelCube,0,mX,mY,z);
